...
class AddressInfoTile: UIStackView {
    ...
    func setSubtitle(mainText: String, additionalText: String) {
        ...
        let firstAttributes: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor.white, NSAttributedString.Key.font:  AppFonts.SFSubheadlineSemibold.fontStyle]
        
        let secondAttributes = [NSAttributedString.Key.foregroundColor: UIColor.white.withAlphaComponent(0.5), NSAttributedString.Key.font:  AppFonts.SFSubheadlineSemibold.fontStyle]
