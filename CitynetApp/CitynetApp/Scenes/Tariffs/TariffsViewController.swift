...
final class TariffsViewController: UIViewController, ThemeableViewController {
    ...
    let models: [TariffModel] = [
        .init(name: "Internet", image: AppAssets.speed.load(), type: .internet, tariffInfos: [
            .fiberOptic,
            ...
            .init(name: "Internet + TV", image: AppAssets.speed2.load(), type: .internetAndTV,  tariffInfos: [
                .fiberOptic,
                .speed(amount: "40 mb/s"),
                .freeWifiRouter,
                .tvBox,
                .channels(count: 24)
                  ...
                  price: "37.99 ₼ / Aylıq"),
        .init(name: "Internet + TV + Telefon xətti", image: AppAssets.speed1.load(), type: .internetAndTVAndPhoneLine,
              tariffInfos: [
                .fiberOptic,
                .speed(amount: "40 mb/s"),
                .freeWifiRouter,
...
extension TariffsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.contentView.backgroundColor = adaptiveColor(.whiteBg)
        cell.delegate = self
