...
class ProfitWalletContentView: UIStackView {
    ...
    private lazy var totalProfitAmountLabel: UILabel = {
        let lbl = UILabel()
        lbl.text = "4.308641 ₼"
        lbl.font = AppFonts.SFTitle2Bold.fontStyle.withSize(18)
        lbl.textColor = adaptiveColor(.darkGreen)
        return lbl
    }()
    ...
    private lazy var addressHeaderLabel: UILabel = {
        let lbl = UILabel()
        lbl.text = "Ünvan"
        lbl.font = AppFonts.SFCaption1Regular.fontStyle
        lbl.textColor = adaptiveColor(.slate)
        return lbl
    }()
    ...
    private lazy var addressLabel: UILabel = {
        ...
        lbl.textColor = adaptiveColor(.cardColor)
        return lbl
    }()
